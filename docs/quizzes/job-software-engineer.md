...
1. **Complete a challenge** from our [quiz collection](./README.md):
   - [Getting Started](./01-getting-started.md) (required, 30 min)
   - Plus ONE of:
     - [Architecture Deep Dive](./02-architecture-deep-dive.md) (backend focus)
     - [Frontend Challenge](./04-frontend-challenge.md) (frontend focus)
...
2. **Submit your application:**
   ...
   - Include:
     - Resume/CV
     - GitHub profile
     - Link to your completed challenge (GitHub Gist)
     - Brief intro about yourself

3. **What happens next:**
   - We review your submission (1-2 weeks)
